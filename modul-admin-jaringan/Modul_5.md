...
![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0064-01.png)
...
![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0067-02.png)


2. docker compose logs fluent-bit — Fluent Bit menerima log (JSON lines di stdout) 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0067-04.png)


3. SELECT COUNT(*) FROM logs.fluentbit — jumlah total log > 0 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0067-06.png)


## 4. SELECT tag, time, data FROM logs.fluentbit LIMIT 3 — raw 3-kolom data 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0067-08.png)


5. SELECT * FROM logs.recent_logs LIMIT 10 — log terbaru via view 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0067-10.png)


6. SELECT * FROM logs.structured_logs LIMIT 10 — parsed JSON log 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0067-12.png)


7. Query distribusi per tag — output tabe 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0068-00.png)


8. Query distribusi per level — output tabel 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0068-02.png)


9. SELECT * FROM logs.error_summary — summary error 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0068-04.png)


10. Query log rate per menit — output tabel 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0068-06.png)


11. curl /api/logs/stats — response JSON 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0069-00.png)


12. curl /api/logs/stats — response JSON 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0069-02.png)
...
![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0070-08.png)


Distribusi log per tag/container: 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0070-10.png)


Distribusi log per level: 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0070-12.png)
...
![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0071-00.png)


3. Ketika container fluent-bit distop, container lain tidak akan hilang 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0071-02.png)


Lalu untuk log tidak menghilang dan bertambah ketika fluent-bit kembali hidup 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0071-04.png)
...
![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0072-01.png)


## 0.5 detik 


![](gambar/3124600041_AQILA_WISAM_MADANI_MA'MURRI_WAJ_DOCKER_MODUL_1-6_-1-.pdf-0072-03.png)
